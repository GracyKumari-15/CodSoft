...
# Labels
Label(root, text="Operation:").grid(row=1, column=0, padx=5, pady=5)
Label(root, text="Number 1:").grid(row=0, column=0, padx=5, pady=5)
Label(root, text="Number 2:").grid(row=2, column=0, padx=5, pady=5)
...
# Result Label
label_result = Label(root, text=" SOLUTION :")
